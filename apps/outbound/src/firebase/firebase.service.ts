...
export class FirebaseService implements ISendMessageProsess {
  ...
  private async sendMessage(
    ...
    const result = await admin
      ...
      .then((response) => {
        ...
        return this.parserMessage(dto.token, null);
      })
      .catch((error) => {
        console.log('Failed send message:', error);
        return this.parserMessage(dto.token, error.code);
      });
  ...
  private parserMessage(
    ...
    const r = {
      token: token,
      errorCode: errorCode,
    } as FirebaseSendMessageOutputPortDto;
    if (!errorCode) {
      return r;
    }
    switch (errorCode) {
      case 'messaging/invalid-argument':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.INVALID_DATA,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/payload-size-limit-exceeded':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.LIMITED,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/invalid-registration-token':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.INVALID_TOKEN,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/message-rate-exceeded':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.EXCEEDED,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/too-many-topics':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.TOO_MANY_TOPICS,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/invalid-apns-credentials':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.CERDENTIALS,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/authentication-error':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.AUTH,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/server-unavailable':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.UNAVAILABLE,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/internal-error':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.INTERNAL,
        } as FirebaseSendMessageOutputPortDto;
      ...
      case 'messaging/unknown-error':
        ...
        return {
          ...r,
          status: FirebaseMessageStatus.UNKNOWN,
        } as FirebaseSendMessageOutputPortDto;
    }
  }
}
